...
export default function Categories() {
  return (
    <div className="md:flex lg:flex mt-20 md:justify-between">
      {categories.map((category) => (
        ...
        >
          <Link href={`/${category.title}`} key={nanoid()}>
            ...
            />
            <p className="uppercase text-[15px] lg:text-[18px] text-center mt-10 font-bold">
              {category.title}
            </p>
            <div className="flex justify-center items-center mt-[10px]">
              <p className="hover:text-orange mr-[10px] text-[13px] font-bold">
                SHOP
              </p>
              <Image
